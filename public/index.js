...
/***/ function(module, exports, __webpack_require__) {
	...
	var Griddle = __webpack_require__(160);

	// Row component for Griddle
	var TableRow = __webpack_require__(175);

	// Paging component for Griddle
	var Paging = __webpack_require__(176);

	// External Input Data from server
	var VEHICLESJSON = __webpack_require__(177);
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var vehiclesList = this.state.vehicles.filter((function (vehicle) {
	      ...
	      if (this.state.type) {
	        typeOk = vehicle.type == "car" && this.state.type == 1 || vehicle.type == "motorbike" && this.state.type == 2 ? true : false;
	      }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'apptitle' },
	        React.createElement('i', { className: 'fa fa-bars enabled' }),
	        'Vehicles'
	      ),
	      React.createElement(
	        'div',
	        { id: 'sidebar', onClick: this.onClickMenu },
	        React.createElement(
	          'h3',
	          { className: 'h3-menu' },
	          'LEVELS'
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'li',
	            { id: 'level 0', className: 'li-menu-level-selected' },
	            'All'
	          ),
	          React.createElement(
	            'li',
	            { id: 'level 1', className: 'li-menu-level' },
	            'Level 1'
	          ),
	          React.createElement(
	            'li',
	            { id: 'level 2', className: 'li-menu-level' },
	            'Level 2'
	          ),
	          React.createElement(
	            'li',
	            { id: 'level 3', className: 'li-menu-level' },
	            'Level 3'
	          ),
	          React.createElement(
	            'li',
	            { id: 'level 4', className: 'li-menu-level' },
	            'Level 4'
	          )
	        ),
	        React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'li',
	            { id: 'type 0', className: 'li-menu-type-selected' },
	            'All'
	          ),
	          React.createElement(
	            'li',
	            { id: 'type 1', className: 'li-menu-type' },
	            'Car'
	          ),
	          React.createElement(
	            'li',
	            { id: 'type 2', className: 'li-menu-type' },
	            'Motorbike'
	          )
	        )
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var React = __webpack_require__(3);
	var GridTable = __webpack_require__(161);
	var GridFilter = __webpack_require__(167);
	var GridPagination = __webpack_require__(168);
	var GridSettings = __webpack_require__(169);
	var GridNoData = __webpack_require__(170);
	var GridRow = __webpack_require__(171);
	var CustomRowComponentContainer = __webpack_require__(173);
	var CustomPaginationContainer = __webpack_require__(174);
	var ColumnProperties = __webpack_require__(164);
	var RowProperties = __webpack_require__(166);
	var deep = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var React = __webpack_require__(3);
	var GridTitle = __webpack_require__(162);
	var GridRowContainer = __webpack_require__(165);
	var ColumnProperties = __webpack_require__(164);
	var RowProperties = __webpack_require__(166);
	var _ = __webpack_require__(163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("c:\\-- AZ --\\CodeX Software\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "TableRow.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paging = React.createClass({
	  ...
	  render: function render() {
	    ...
	    previous = React.createElement(
	      "span",
	      { onClick: this.props.previous, className: classPrevious },
	      React.createElement("i", { className: "fa fa-chevron-up fa-2x" })
	    );

	    next = React.createElement(
	      "span",
	      { onClick: this.props.next, className: classNext },
	      React.createElement("i", { className: "fa fa-chevron-down fa-2x" })
	    );
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "row-custom-pager-gap" },
	        React.createElement(
	          "p",
	          null,
	          currentGapFrom
	      ...
	      React.createElement(
	        "div",
	        { className: "row-custom-pager-nav" },
	        previous,
	        next
	      )
	    );
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("c:\\-- AZ --\\CodeX Software\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Paging.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__resourceQuery) {var io = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Manager = __webpack_require__(191);
	...
	exports.Socket = __webpack_require__(223);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isBuf = __webpack_require__(190);
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (window) {
	  ...
	  var isLoader = "function" === "function" && __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Socket = __webpack_require__(223);
	var Emitter = __webpack_require__(188);
	var parser = __webpack_require__(184);
	var on = __webpack_require__(225);
	var bind = __webpack_require__(226);
	var object = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseuri = __webpack_require__(221);
	var parsejson = __webpack_require__(222);
	...
	Socket.transports = __webpack_require__(195);
